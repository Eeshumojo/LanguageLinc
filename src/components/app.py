...
def video_to_translate(url,initial_language,final_language):
    ...
    # Determine language codes for initial and final languages
    ...
    # Internal definitions
    lang_in = initial_lang_code
    lang_api = initial_lang_code
...
initial_language = gr.inputs.Dropdown(all_languages, label="Initial Language")
final_language = gr.inputs.Dropdown(all_languages, label="Final Language")
...
gr.Interface(
    ...
    verbose=True,
    title='LanguageLinc',
    description='Breaking language boundaries with multilanguage translation',
    article='''
